...
impl VaultCreate {
    ...
    pub fn getAccountsWasm(programKey: &[u8], userKey: &[u8]) -> Result<Vec<AccountWasm>, String> {
...
unsafe impl Pod for VaultCreate {}

impl Command for VaultCreate {
    const ID: u32 = 0xc4ff8deb;
    type Keys = UserKey;
