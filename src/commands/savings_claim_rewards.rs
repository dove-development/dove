...
pub struct SavingsClaimRewards {
    _private: (),
}

#[cfg(feature = "wasm")]
#[wasm_bindgen]
impl SavingsClaimRewards {
...
unsafe impl Pod for SavingsClaimRewards {}

impl Command for SavingsClaimRewards {
    const ID: u32 = 0xc19f160c;
