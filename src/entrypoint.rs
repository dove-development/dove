use {
    crate::{
        commands::{
            ...
            StabilityBuyDvd, StabilityCreate, StabilitySellDvd, StabilityUpdateMintLimit,
...
pub fn process_instruction(
    ...
    match id {
        ...
        StabilityUpdateMintLimit::ID => StabilityUpdateMintLimit::cast_from(cmd_data).execute(program_id, accounts),
